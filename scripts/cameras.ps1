...
"@
    ...
    Write-Info "  3. The live picture starts as soon as that is saved."
    Write-Info ""
    Write-Info "  Nothing is recorded to disk. This console is for watching the"
    Write-Info "  camera now. To record as well, tick 'Record everything to disk'"
    Write-Info "  in the Storage box on the same Settings tab."
    Write-Host ""
